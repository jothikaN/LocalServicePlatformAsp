...
namespace LocalServicePlatform.Infrastructure.Migrations
{
    ...
    [Migration("20240726130704_taskeruppdateedit")]
    partial class taskeruppdateedit
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LocalServicePlatform.Domain.Models.TaskersService", b =>
                {
                    b.Property<Guid>("TaskersUpdateId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("TaskersUpdateId", "ServiceId");

                    b.HasIndex("ServiceId");

                    b.HasIndex("ServicesId");

                    b.ToTable("TaskersService");
                });

            modelBuilder.Entity("LocalServicePlatform.Domain.Models.TaskersUpdate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LocalServicePlatform.Domain.Models.TaskersService", b =>
                {
                    ...
                    b.HasOne("LocalServicePlatform.Domain.Models.Services", null)
                        .WithMany("TaskersServices")
                        .HasForeignKey("ServicesId");

                    b.HasOne("LocalServicePlatform.Domain.Models.TaskersUpdate", "TaskersUpdate")
                        .WithMany("TaskersServices")
                        .HasForeignKey("TaskersUpdateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Services");

                    b.Navigation("TaskersUpdate");
                });
